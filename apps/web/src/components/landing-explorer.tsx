...
const capabilities: Capability[] = [
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        output: "Validation Score: 99.4% (Passed)",
  ...
  },
  {
    ...
    nodes: [
      ...
      },
      {
        ...
        type: "model",
        input: "50 Citizen Reports (100m radius)",
      ...
      },
      {
        ...
        output: "Defect: Water Main Rupture (98.4%)",
    ...
    facts: [
      ...
      "DBSCAN spatial clustering merges 50 reports into 1 incident",
